...
#####################################################################
# ChessBoard v2.03 is created by John Eriksson - http://arainyday.se
...
class ChessBoard:
    ...
    def setFEN(self,fen):
        ...
        #EN PASSANT
        if len(fparts[3]) == 2:
            newstate += "abcdefgh".index(fparts[3][0].lower())
            newstate += "87654321".index(fparts[3][1])
        else:
            newstate += "00"
